...
export interface Contact {
  ...
  user_id: string;
  account_id: string;
  /** Nullable since migration 044 — an Instagram-only contact (DMs
   *  but never shares a phone number) has no phone. A contact always
   *  has at least one of `phone`/`instagram_id` (DB CHECK). */
  phone?: string | null;
