 ...
 * same generation path a real reply would — the `auto_reply` system
 * prompt + the configured provider — so what you see here is close to
 * what a customer would get. Reads the config even when the master
