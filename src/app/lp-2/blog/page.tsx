...
// Noindex: the live /blog serves the same posts from the same table
// (getPublishedPosts). Indexing this too would be self-competing
// duplicate content — see the note on the promoted (marketing)/blog.
