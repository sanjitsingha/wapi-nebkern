...
// Noindex, unlike the legal pages. The live /blog is already indexed and
// serves the same posts from the same table, so indexing this too would
// be self-competing duplicate content. Flip to `index: true` at the same
// moment /lp-2 replaces / — not before.
