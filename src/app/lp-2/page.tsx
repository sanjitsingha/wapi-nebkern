...
// The original marketing landing page, kept as a secondary variant at
// /lp-2 now that the newer (marketing) rebuild lives at `/`. Noindexed
// to avoid the same domain competing with itself for the same pitch —
// flip back only if this ever becomes the front door again.
